...
/**
 * An illustrative implementation of the random Bernoulli set model.
 * 
 * Implementations in general will be more sophisticated in how they
 * generate (efficient) implementations of Bernoulli sets. This
