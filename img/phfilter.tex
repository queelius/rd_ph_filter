...
\begingroup%
  ...
  \begin{picture}(1,0.54970412)%
    ...
    \put(0.09855085,0.52){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{set $\St$}}}%
    ...
    \put(0.1,0.00775393){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{perfect hash function of set $\St$}}}%
